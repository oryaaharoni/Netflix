    ...
    return (
        <div className='headDiv'>
            ...
            <form className='signInForm'>
                ...
                {changeContent &&
                    <input className='signInInput' name='password' placeholder='Password' />
                }
                ...
                <a className='linkForgot' href=''>{changeContent ? 'Forgot Password' : 'Forgot Email or Phone Number?'}</a>
